  ...
  <View style={styles.itemProduct}>
    <View style={styles.mainProduct}>
      ...
      <View style={styles.function}>
        ...
        >
          <TouchableOpacity>
          <AntDesign name="plus" size={18} color="black" /></TouchableOpacity>
        </View>
        ...
        >
          <TouchableOpacity>
          <AntDesign name="minus" size={18} color="white" /></TouchableOpacity>
        </View>
      </View>
    </View>
  </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.footter}>
        <View style={styles.totalProduct}>
          <Text>Tạm tính:</Text>
          <Text style={{ fontSize: 18, fontWeight: "bold",color:'red' }}>2212.000đ</Text>
        </View>
